import{_ as s,v as a,b as n,R as l}from"./chunks/framework.caa0fbaf.js";const y=JSON.parse('{"title":"Android JNI","description":"","frontmatter":{},"headers":[],"relativePath":"Android/android-jni/index.md","filePath":"Android/android-jni/index.md"}'),e={name:"Android/android-jni/index.md"},p=l(`<h1 id="android-jni" tabindex="-1">Android JNI <a class="header-anchor" href="#android-jni" aria-label="Permalink to &quot;Android JNI&quot;">​</a></h1><h2 id="javah" tabindex="-1">javah <a class="header-anchor" href="#javah" aria-label="Permalink to &quot;javah&quot;">​</a></h2><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">用法: </span></span>
...
<span class="line"><span style="color:#A6ACCD;">(例如, java.lang.Object)。</span></span></code></pre></div>`,3),o=[p];function t(i,c,r,d,A,C){return a(),n("div",null,o)}const D=s(e,[["render",t]]);export{y as __pageData,D as default};
