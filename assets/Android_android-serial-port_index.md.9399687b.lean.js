import{_ as s,v as n,b as a,R as e}from"./chunks/framework.caa0fbaf.js";const v=JSON.parse('{"title":"Android 串口通信","description":"","frontmatter":{},"headers":[],"relativePath":"Android/android-serial-port/index.md","filePath":"Android/android-serial-port/index.md"}'),l={name:"Android/android-serial-port/index.md"},p=e(`<h1 id="android-串口通信" tabindex="-1">Android 串口通信 <a class="header-anchor" href="#android-串口通信" aria-label="Permalink to &quot;Android 串口通信&quot;">​</a></h1><div class="language-"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki material-theme-palenight"><code><span class="line"><span style="color:#A6ACCD;">/* OnePlus 6</span></span>
